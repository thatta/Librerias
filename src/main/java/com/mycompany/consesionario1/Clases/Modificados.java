 ...
 */
public class Modificados extends Carro{
    /**
     ...
     */
    public Modificados(String codigo, String referencia, double velocidad, String marca, String color, int puertas, double precio) {
